                ...
                <div className="row">
                  ...
                  <div className="col-lg-6">
                    ...
                    <p className="card-text">
                      ...
                      จะต้องนำเทคโนโลยีดิจิทัลมาใช้นะคะทุกคน
                      และใช้ในการบริหารจัดการ เพื่อให้บริการแก่ประชาชน
                    </p>
                    <a
                      href="assets/PMQA4.0-1-24.pdf"
                      target="_blank"
                ...
                <div className="row">
                  ...
                  <div className="col-lg-6">
                    ...
                    <p className="card-text">
                      ...
                      เพื่อการเปลี่ยนแปลงและการพัฒนาองค์การในภาครัฐ ในยุคดิจิทัล
                    </p>
                    <a
                      href="assets/PMQA4.0-33-41.pdf"
                      target="_bank"
                      rel="noopener noreferrer"
                      className="btn btn-primary"
                    >
                ...
                <div className="row">
                  ...
                  <div className="col-lg-6">
                    ...
                    <p className="card-text">
                      ...
                      เพื่อการพัฒนาคุณภาพการบริหารการจัดการภาครัฐในยุคดิจิทัล4.0
                    </p>
                    <a
                      href="assets/PMQA4.0-42-57.pdf"
                      target="_bank"
                      rel="noopener noreferrer"
                      className="btn btn-primary"
                    >
