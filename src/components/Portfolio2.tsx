        ...
        <div className="full-title">
          <div className="container">
            ...
            <h1 className="mt-4 mb-3">
              การจัดกิจกรรมเพื่อพฒนาองค์การภาครัฐ<small>Subheading</small>
            </h1>
          </div>
        </div>
        {/* Page Content */}
          ...
          <div className="breadcrumb-main">
            <ol className="breadcrumb">
              ...
              <li className="breadcrumb-item active">
                การจัดกิจกรรมเพื่อพฒนาองค์การภาครัฐ
              </li>
            </ol>
          </div>
          <div className="row">
              ...
              <div className="card h-100">
                ...
                <div className="card-body">
                  <h4 className="card-title">
                    <a
                      href="assets/organization_intervention"
                      target="_blank"
                  ...
                  <p className="card-text">
                    ...
                    ที่มุ่งทำให้ทั้งองค์การและบุคลากรทำงานบรรลุผลสำเร็จตามเป้าหมาย
            ...
            <div className="col-lg-6 portfolio-item">
              <div className="card h-100">
                ...
                <div className="card-body">
                  <h4 className="card-title">
                    <a
                      href="assets/organization-intervention25-32.pdf"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                  ...
                  <p className="card-text">
                    การปรับโครงสร้างองค์กร หมายถึง
            ...
            <div className="col-lg-6 portfolio-item">
              <div className="card h-100">
                ...
                <div className="card-body">
                  <h4 className="card-title">
                    <a
                      href="assets/organization-interventio33-41.pdf"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                  ...
                  <p className="card-text">
                    การมีส่วนร่วมของพนักงาน คือ
                    การได้รับรวมเป็นส่วนหนึ่งของทีมอย่างเต็มตัว
            ...
            <div className="col-lg-6 portfolio-item">
              <div className="card h-100">
                ...
                <div className="card-body">
                  <h4 className="card-title">
                    <a
                      href="assets/organization-interventio42-57.pdf"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                  ...
                  <p className="card-text">
                    กลยุทธ์การแข่งขันและการมีส่วนร่วม
                    คือแผนปฏิบัติการระยะยาวที่องค์กรพัฒนาและดำเนินการเพื่อสร้างและรักษาข้อได้เปรียบในการแข่งขัน
                  </p>
                </div>
              </div>
            </div>
            <div className="col-lg-6 portfolio-item">
              <div className="card h-100">
                ...
                <div className="card-body">
                  <h4 className="card-title">
                    <a
                      href="assets/technostructure/technostructure-1-32.pdf"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      การออกแบบงาน
                  ...
                  <p className="card-text">
                    การออกแบบงาน เป็นวิธีการจัด ตำแหน่งหน้าที่
            ...
            <div className="col-lg-6 portfolio-item">
              <div className="card h-100">
                ...
                <div className="card-body">
                  <h4 className="card-title">
                    <a
                      href="assets/technostructure/technostructure-33-54.pdf"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      การ Coaching
            ...
            <div className="col-lg-6 portfolio-item">
              <div className="card h-100">
                ...
                <div className="card-body">
                  <h4 className="card-title">
                    <a
                      href="assets/technostructure/technostructure-55-77.pdf"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      การสร้างทีม
                  ...
                  <p className="card-text">
                    ...
                    ต้องมีการสร้างทีมที่มีความสามัคคี และมีเป้าหมายการทำงาน
                  </p>
                </div>
              </div>
            </div>
            <div className="col-lg-6 portfolio-item">
              <div className="card h-100">
                ...
                <div className="card-body">
                  <h4 className="card-title">
                    <a
                      href="assets/technostructure/technostructure-78-123.pdf"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                  ...
                  <p className="card-text">
                    ...
                    คือกระบวนการพัฒนาวัฒนธรรมองค์กรของคุณในรูปแบบที่แท้จริงซึ่งดึงดูดผู้คนและสร้างแรงบันดาลใจให้ทีมทำงานได้อย่างเต็มประสิทธิภาพ
